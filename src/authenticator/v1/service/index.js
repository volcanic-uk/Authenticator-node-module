...
class Service extends V1Base {
    ...
    async getServices({ page = '', page_size = '', name = 'auth', sort = 'id', order = 'asc', ids = '' }) {
        return super.fetch('get', `services?page=${page}&page_size=${page_size}&name=${name}&sort=${sort}&order=${order}&ids=${ids}`, null);
    }
