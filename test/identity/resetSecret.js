...
describe('reset secret', () => {
    before(async () => {
        ...
        await new Identity().withAuth().create(tmpIdentityName + 'create-name', tmpIdentitySecret, 1, [1]);
        ...
        identityCreation = await new Identity().withAuth().create(tmpIdentityName + '-withtoken1', null, 1);
