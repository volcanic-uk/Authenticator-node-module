...
describe('update a service', async () => {
    ...
    it('should update a service', async () => {
        axiosVCR.mountCassette('./test/cassettes/services/update/service_update.json');
        ...
        axiosVCR.ejectCassette('./test/cassettes/services/update/service_update.json');
    });
    it('should not update a non-exist service', async () => {
        try {
            axiosVCR.mountCassette('./test/cassettes/services/update/service_update_fail.json', true);
            await new Service().withAuth().update(`${currentTimestampSecond}`, `service-name-update-${currentTimestampSecond}`);
            axiosVCR.ejectCassette('./test/cassettes/services/update/service_update_fail.json');
        } catch (e) {
