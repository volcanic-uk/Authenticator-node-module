...
describe('update a permission', async () => {
    it('should update a permission', async () => {
        ...
        let updatepermission = await new Permission().withAuth().update({ id: 64, name: 'updated_test_name' });
    ...
    it('should not update a non-exist permission', async () => {
        try {
            ...
            await new Permission().withAuth().update({ id: 1234213, name: 'updated_test_name' });
        } catch (e) {
