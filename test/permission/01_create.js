...
describe('create permission', async () => {
    ...
    it('should create a permission', async () => {
        axiosVCR.mountCassette('./test/cassettes/permissions/create/permission_create.json');
        await new Permission().withAuth().create(`new-permission-${currentTimestampSecond}`, 'this is new permission', 2);
        axiosVCR.ejectCassette('./test/cassettes/permissions/create/permission_create.json');
    });
    it('should not create duplicated permission', async () => {
        axiosVCR.mountCassette('./test/cassettes/permissions/create/permission_create_fail.json', true);
        try {
        ...
        axiosVCR.ejectCassette('./test/cassettes/permissions/create/permission_create_fail.json');
    });
    it('should not create permission without name', async () => {
        axiosVCR.mountCassette('./test/cassettes/permissions/create/permission_create_fail_no_name.json', true);
        try {
        ...
        axiosVCR.ejectCassette('./test/cassettes/permissions/create/permission_create_fail_no_name.json');
    });
});